...
{
  "code": 0,
  "checkInTime": "2024-11-11T10:30:00", // 从room表获取
  "message": "查询成功",
  "data": {
      "cost": 12.5, // 从room表获取的cost是用电量，此处需用电量*单位时间电费（1元1度）计算
      "people": [ // 从people表获取
        {
          "peopleId": 1001,
          "peopleName": "张三"
      ...
      "records": [
        {
          "time": "2023-11-14T10:00:00", // 从aircon_history表获取，若startTime存在，则以startTime为该item的时间；若startTime为NULL，则以requestTime为该item的时间
          "cost": "2.5", // 从aircon_history获取的cost即为此处的cost
          "power": "on", // 从aircon_history获取
          "temperature": 25, // 从aircon_history获取 
          "windSpeed": "低", // 从aircon_history获取
          "mode": "制冷", // 从aircon_history获取
          "sweep": "开" // 从aircon_history获取
        },
        {
          "time": "2023-11-14T11:00:00",
          "cost": "1.8",
          "power": "on", 
          "temperature": 23,
          "windSpeed": "中",
...
响应数据样例
{
    ...
    "data": [
        {
            "roomId": 2001, // 各table主要查询依据
            "roomLevel": "标准间", // 从rooms表中获取
            "people": [ // 从roomPeople表中获取
                {
                    "peopleId": 1,
                    "peopleName": "王大锤"
                },
            ...
            "cost":100.00, // 从rooms表中获取
            "roomTemperature":26, // 从settings表中获取
            "power": "on", // 从settings表中获取
            "temperature": 24, // 从settings表中获取
            "windSpeed": "中", // 从settings表中获取
            "mode": "制冷", // 从settings表中获取
            "sweep": "开" // 从settings表中获取
        },
        {
            "roomId": 3002,
            "roomLevel": "大床房",
